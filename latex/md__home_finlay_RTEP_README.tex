...
The repository describes how to measure E\+MG signals from the user\textquotesingle{}s bicep and/or ticep muscles, and how these are then used in turn to control the movement of a paddle in the classic game Pong \+:ping\+\_\+pong\+:(the principles being completely transferrable to other relatively rudimentary games).\hypertarget{md__home_finlay_RTEP_README_autotoc_md1}{}\doxysection{Premise}\label{md__home_finlay_RTEP_README_autotoc_md1}
...
The primary use of this system is to increase the level of submersion the player feels within the gaming environment, providing a new challenge, and adding a new dimension to the gaming experience. The system also has potential application in the field of rehabilitation, encouraging persistence with otherwise unpleasent rehabilitation regimes.\hypertarget{md__home_finlay_RTEP_README_autotoc_md2}{}\doxysection{E\+M\+G Measurement \+:muscle\+:}\label{md__home_finlay_RTEP_README_autotoc_md2}
...
\hypertarget{md__home_finlay_RTEP_README_autotoc_md3}{}\doxysection{Progress}\label{md__home_finlay_RTEP_README_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{md__home_finlay_RTEP_README_autotoc_md4}{}\doxysection{Social Media}\label{md__home_finlay_RTEP_README_autotoc_md4}
